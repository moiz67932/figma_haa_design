        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div className="relative">
              <img src={nft.image || "/placeholder.svg"} alt={nft.name} className="w-full rounded-3xl object-cover" />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-6">
              <div className="space-y-2">
                ...
                <p className="text-3xl font-bold text-gray-900 dark:text-white">{nft.price}</p>
                <p className="text-lg text-gray-500 dark:text-gray-400">{nft.usdPrice}</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <Button variant="outline" size="icon" onClick={() => copyToClipboard(nft.owner)} className="rounded-xl">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {nft.traits.map((trait: any, index: number) => (
                  <div key={index} className="p-3 bg-gray-50 dark:bg-gray-800/50 rounded-2xl text-center">
                    <p className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">
                      {trait.trait_type}
                    </p>
                    <p className="font-semibold text-gray-900 dark:text-white">{trait.value}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <Button
                variant="outline"
                onClick={() => window.open(`https://opensea.io/assets/${nft.id}`, "_blank")}
